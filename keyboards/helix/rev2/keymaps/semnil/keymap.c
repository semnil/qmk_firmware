...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * |Lower | Alt  | GUI  |Adjust|   `  | EISU |Space |Space | KANA |   -  |   =  | GUI  |   \  |Raise |
   * `-------------------------------------------------------------------------------------------------'
   */
  [_QWERTY] = LAYOUT( \
      ...
      LOWER,   KC_LALT, KC_LGUI, ADJUST,  KC_GRV,  EISU,    KC_SPC,  KC_SPC,  KANA,    KC_MINS, KC_EQL,  KC_RGUI, KC_BSLS, RAISE \
      ),
  ...
  [_ADJUST] =  LAYOUT( \
      ...
      _______, AG_NORM, AG_SWAP, _______, RESET,   _______,                   _______, _______, _______, _______, _______, _______, \
      _______, _______, _______, AU_ON,   AU_OFF,  _______,                   _______, QWERTY,  _______, _______, _______, _______, \
      _______, _______, _______, _______, _______, _______, _______, _______, _______, RGB_MOD, RGB_HUI, RGB_SAI, RGB_VAI, _______, \
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT( \
      ...
      ADJUST,  KC_ESC,  KC_LALT, KC_LGUI, EISU,    LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_RSFT \
      ),
